...
public class FeatureMapQualityUi {
    ...
    class QualityBar {
        ...
        public void updateQuality(Session.FeatureMapQuality quality) {
    ...
    public void updateQualityForViewpoint(float[] cameraPosition, Session.FeatureMapQuality quality) {
