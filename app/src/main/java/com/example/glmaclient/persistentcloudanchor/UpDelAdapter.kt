...
class UpDelAdapter(private var userList: ArrayList<Model>, private val context: Context) : RecyclerView.Adapter<UpDelAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            val intent = Intent(context, UpDelDeceasedInfo::class.java).apply {
